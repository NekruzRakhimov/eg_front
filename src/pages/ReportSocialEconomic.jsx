...
const ReportSocialEconomic = () => {
    const [mainContent, setMainContent] = useState(
        [
            ...
            {
                "indicator": "Средняя заработная плата",
                "value": "75 087 \nрублей"
            },
            {
                "indicator": "Объем поступлений налогов и сборов",
                "value": "3 385,8 \nмлрд рублей"
            },
            {
                "indicator": "Объем отгруженных товаров собственного производства",
                "value": "4 788,9 \nмлрд рублей"
            },
            {
                "indicator": "Информация о распределении производственных сил",
                "value": "5 575 \nвыпускников"
            }
        ]
    );
        ...
        [
            ...
            },
            {
                ...
                "items": [
                    ...
                    {
                        "code": "3507215",
                        "title": "н.Ч.Балхи (Ч. Руми)"
                    },
                    {
                        "code": "3507217",
                        "title": "н.Кушониён (н.Бохтар)"
                    },
                    {
                        "code": "3507219",
                        "title": "н.р-н А.Чоми"
                    ...
                    {
                        "code": "3507246",
                        "title": "н.Шамсиддин Шохин (Шурообод)"
                    },
                    {
                        "code": "3507250",
                        "title": "н.Ёвон"
                    ...
                    {
                        "code": "3507401",
                        "title": "шБохтар (ш.Кургон-Теппа)"
                    },
                    {
                        "code": "3507403",
                        "title": "ш.Леваканд (ш.Сарбанд)"
                    },
                    {
                        "code": "3507405",
                        "title": "ш.Кулоб"
            ...
            {
                "code": "05",
                "title": "Районы республиканского подчинения",
                "items": [
                    {
                        "title": "ш.Вахдат",
                        "code": "3509018"
    ...
    const [chosenArea, setChosenAre] = useState(
        areas["TJ-RR"]
    );
    ...
    const handleChangeValue = (chosenArea) => {
        setChosenAre(areas[chosenArea]);
    };

    const handleCity = (chosenACity) => {
        setChosenCity({
            "title": chosenACity
        });
    };
    ...
    return (
        <div>
            <h1 className={"ReportsMainHeader"}>Социально-экономический</h1>
            <div className={"ReportSocialEconomic-MainContent"}>
                <div>
                    <h3 className={"ReportsSubHeader"}>Общий отчет</h3>
                    ...
                    <table className="enterprises__table">
                        ...
                        {mainContent.map((item, index) =>
                            ...
                            >
                                ...
                                <td>{item.value}</td>
                                <td>{chosenArea["content"][index].value}</td>
            ...
            <div className={"ReportSocialEconomic-DetailedReport-Container"}>
                ...
                <div className={"ReportSocialEconomic-DetailedReport"}>
                    ...
                    <div className={"ReportSocialEconomic-DetailedReport-Table"}>
                        {/*<div className="add-licence-btn">*/}
                        {/*    <MyButton style={{marginTop: "30px"}} onClick={() => setModal(true)}>*/}
                        {/*        + Добавить лицензию*/}
                        {/*    </MyButton>*/}
                        ...
                        <table className="enterprises__table">
                            ...
                            <tr className="enterprises__table__headers">
                                <th>Показатели</th>
                                <th>{chosenCity["title"]}</th>
                            </tr>
                            </tbody>
                            <tbody>
                            <tr className="table_link">
                                <td>Количество предприятий</td>
                                <td>0</td>
                            </tr>
                            <tr className="table_link">
                                <td>Объем поступлений налогов и сборов</td>
                                <td>0</td>
                            </tr>
                            <tr className="table_link">
                                <td>Объем отгруженных товаров собственного производства</td>
                                <td>0</td>
                            </tr>
                            <tr className="table_link">
                                <td>Информация о распределении производственных сил</td>
                                <td>0</td>
                            </tr>
                            </tbody>
                        </table>
